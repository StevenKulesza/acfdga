...
$wp_customize->add_setting( 'themeslug_logo_mobile' );
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'themeslug_logo_mobile', array(
    'label'    => __( 'Mobile Logo', 'themeslug' ),
    'section'  => 'themeslug_logo_section',
    'settings' => 'themeslug_logo_mobile',
    'priority'    => 7
) ) );
...
/*** Yelp ***/
$wp_customize->add_setting( 'themeslug_yelp',
	array (
		'default' => '#',
		 ) );
$wp_customize->add_control( 'themeslug_yelp', array(
    'label'    => __( 'Yelp URL', 'themeslug' ),
    'section'  => 'themeslug_social_section',
    'type' => 'text',
    'priority'    => 17,
) );
$wp_customize->add_setting( 'themeslug_show_yelp',
	array (
		'default' => '#',
) );
$wp_customize->add_control( 'themeslug_show_yelp', array(
    'label'    => __( 'Show Yelp', 'themeslug' ),
    'section'  => 'themeslug_social_section',
    'type' => 'checkbox',
    'priority'    => 18,
) );
...
/*** Trip Advisor ***/
$wp_customize->add_setting( 'themeslug_tripadvisor',
	array (
		'default' => '#',
		 ) );
$wp_customize->add_control( 'themeslug_tripadvisor', array(
    'label'    => __( 'Trip Advisor URL', 'themeslug' ),
    'section'  => 'themeslug_social_section',
    'type' => 'text',
    'priority'    => 19,
) );
$wp_customize->add_setting( 'themeslug_show_tripadvisor',
	array (
		'default' => '#',
) );
$wp_customize->add_control( 'themeslug_show_tripadvisor', array(
    'label'    => __( 'Show Trip Advisor', 'themeslug' ),
    'section'  => 'themeslug_social_section',
    'type' => 'checkbox',
    'priority'    => 20,
) );
